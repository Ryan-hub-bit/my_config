...
var SessionList = class extends import_coc10.BasicList {
  ...
  async getSessionFolder() {
    ...
    directory = directory.replace(/^~/, import_os2.default.homedir());
    const isWin = process.platform === "win32";
    if (!directory) {
      const folder = isWin ? "vimfiles/sessions" : ".vim/sessions";
      directory = import_path7.default.join(import_os2.default.homedir(), folder);
    }
    if (!import_fs5.default.existsSync(directory)) {
      import_mkdirp.default.sync(directory);
      if (isWin) {
        let folder = import_path7.default.join(import_os2.default.homedir(), ".vim/sessions");
          ...
          if (stat && stat.isDirectory()) {
            ...
            for (let file of files) {
              if (file.endsWith(".vim")) {
                let dest = import_path7.default.join(import_os2.default.homedir(), "vimfiles/sessions", file);
